...
if "TF" in get_backends():
    ...
    def create_optims_bicyclegan_default_tf(optim_cls, **optim_params):
        """
        Function to create a optimizer dictionary
        (in this case two optimizers: One for the generator,
        one for the discriminator)
        ...
        **optim_params :
        ...
        dict
            dictionary containing all created optimizers
        """
        return {"G": optim_cls(**optim_params),
                "E": optim_cls(**optim_params),
                "D": optim_cls(**optim_params),
                #"G_only": optim_cls(**optim_params)
                }
